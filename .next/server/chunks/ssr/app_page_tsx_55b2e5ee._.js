module.exports=[60350,a=>{"use strict";var b=a.i(87924),c=a.i(72131);let d=[{id:"termometre",title:"Termometre Projesi",icon:"🌡️",description:"Sıcaklık ve nem takibi yaparak ortamın konfor seviyesini ölçer. RGB LED ile durumu renkli olarak bildirir.",materials:["Arduino UNO","DHT11 Sensör","16x2 I2C LCD Ekran","RGB LED","Dirençler","Jumper Kablolar"],connections:`
    - DHT11 Sinyal -> D2
    - RGB Kırmızı -> D3
    - RGB Yeşil -> D5
    - RGB Mavi -> D6
