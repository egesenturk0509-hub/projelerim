(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,31713,e=>{"use strict";var i=e.i(43476),a=e.i(71645);let r=[{id:"termometre",title:"Termometre Projesi",icon:"🌡️",description:"Sıcaklık ve nem takibi yaparak ortamın konfor seviyesini ölçer. RGB LED ile durumu renkli olarak bildirir.",materials:["Arduino UNO","DHT11 Sensör","16x2 I2C LCD Ekran","RGB LED","Dirençler","Jumper Kablolar"],connections:`
    - DHT11 Sinyal -> D2
    - RGB Kırmızı -> D3
    - RGB Yeşil -> D5
    - RGB Mavi -> D6
...
`},{id:"uzaktanKumandaAraba",title:"Uzaktan Kumandalı Araba",icon:"🚙",description:"IR kumanda ve L298N motor sürücü kullanarak hazırlanan, engelden kaçan akıllı araç projesi.",materials:["Arduino Uno","L298N Motor Sürücü","4 Adet Sarı DC Motor ve Tekerlek","HC-SR04 Ultrasonik Mesafe Sensörü","IR Alıcı Göz ve Kumanda","Breadboard ve Jumper Kablolar","Güç Kaynağı"],connections:`
    Motor 1 & 2 (Sol taraf): L298N Motor S\xfcr\xfcc\xfc OUT1 ve OUT2 \xe7ıkışlarına paralel bağlanır.
Motor 3 & 4 (Sağ taraf): L298N Motor S\xfcr\xfcc\xfc OUT3 ve OUT4 \xe7ıkışlarına paralel bağlanır.
L298N Motor S\xfcr\xfcc\xfc IN1: Arduino UNO Pin 3 (PWM)
L298N Motor S\xfcr\xfcc\xfc IN2: Arduino UNO Pin 5 (PWM)
L298N Motor S\xfcr\xfcc\xfc IN3: Arduino UNO Pin 6 (PWM)
L298N Motor S\xfcr\xfcc\xfc IN4: Arduino UNO Pin 9 (PWM)
L298N Motor S\xfcr\xfcc\xfc GND: Arduino UNO GND pinine bağlanmalı
L298N Motor S\xfcr\xfcc\xfc VCC: Arduino UNO 5V
HC-SR04 Mesafe Sens\xf6r\xfc Trig: Arduino UNO Pin 2
HC-SR04 Mesafe Sens\xf6r\xfc Echo: Arduino UNO Pin 4
HC-SR04 Mesafe Sens\xf6r\xfc GND: Arduino UNO GND
HC-SR04 Mesafe Sens\xf6r\xfc VCC: Arduino UNO 5V
IR Kumanda Alıcısı VCC: Arduino UNO 5V
IR Kumanda Alıcısı GND: Arduino UNO GND
IR Kumanda Alıcısı Signal : Arduino UNO Pin 11`,code:`#include <IRremote.h>
const int IN1 = 3;
const int IN2 = 5;
const int IN3 = 6;
const int IN4 = 9;
...
`;function l(){let[e,l]=(0,a.useState)("grid"),[t,o]=(0,a.useState)(null);return(0,i.jsxs)("div",{children:[(0,i.jsx)("style",{children:n}),(0,i.jsxs)("header",{children:[(0,i.jsx)("h1",{className:"header-name",children:"Robotik Mühendisliği Projeleri"}),(0,i.jsx)("div",{className:"header-sub",children:"Ege Şentürk | Geleceğin Teknolojileri"})]}),(0,i.jsxs)("div",{className:"container",children:["grid"===e&&(0,i.jsx)("div",{className:"grid",children:r.map(e=>(0,i.jsxs)("div",{className:"card",onClick:()=>{o(e),l("detail")},children:[(0,i.jsx)("div",{className:"icon-box",children:e.icon}),(0,i.jsx)("h3",{children:e.title})]},e.id))}),"detail"===e&&t&&(0,i.jsxs)("div",{className:"detail-view",children:[(0,i.jsx)("button",{className:"btn-back",onClick:()=>l("grid"),children:"⬅ Geri Dön"}),(0,i.jsxs)("h1",{children:[t.icon," ",t.title]}),(0,i.jsx)("p",{children:t.description}),(0,i.jsx)("h3",{children:"📦 Gerekli Malzemeler"}),(0,i.jsx)("ul",{children:t.materials.map((e,a)=>(0,i.jsx)("li",{children:e},a))}),(0,i.jsx)("h3",{children:"🔌 Bağlantı Şeması"}),(0,i.jsx)("div",{className:"code-area",style:{background:"#f0f0f0",color:"#333"},children:t.connections}),(0,i.jsxs)("h3",{children:["💻 Arduino Kodu ",(0,i.jsx)("button",{className:"btn-download",onClick:()=>{var e,i;let a,r;return e=`${t.id}_kod.ino`,i=t.code,a=document.createElement("a"),r=new Blob([i],{type:"text/plain"}),void(a.href=URL.createObjectURL(r),a.download=e,document.body.appendChild(a),a.click(),document.body.removeChild(a))},children:"İndir"})]}),(0,i.jsx)("div",{className:"code-area",children:t.code})]})]})]})}e.s(["default",()=>l])}]);